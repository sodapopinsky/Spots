...
@interface SPPhotoDetailsFooterView ()
@property (nonatomic, strong) UIView *mainView;
@end

@implementation SPPhotoDetailsFooterView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (!hideDropShadow) {
        [SPUtility drawSideAndBottomDropShadowForRect:mainView.frame inContext:UIGraphicsGetCurrentContext()];
